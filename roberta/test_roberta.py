...
parser.add_argument('--model_name', default='/home/yangxiaofan/machine/big/')
...
parser.add_argument('--checkpoint_path',default = "/home/yangxiaofan/machine/FakingFakeNews-master/roberta/outputs/20240617_110346",required=True, type=str)
...
#TODO：#使用测试集
test_set = PropaFakeDataset(os.path.join(args.data_dir,'test5.jsonl'))
# test_set = PropaFakeDataset(os.path.join(args.data_dir,'train.jsonl'))
print(test_set)
